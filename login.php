...
<head>
  ...
  <style type="text/css">
      .login-page {
          background: url(dimg/images/fb4.jpg) no-repeat center center fixed;
...
<div class="login-box">
  <div class="login-logo">
    <a href="index2.html"><b>WUEX</b>.dev</a>
  </div>
  <!-- /.login-logo -->
...
//      echo "</pre>";
      if (isset($_COOKIE['adminsLogin'])){
          ...
          //echo $login->admins_username;
          //echo $login->admins_pass;
      }

      $sonuc = ['status' => FALSE];

      if (isset($_POST['admins_login'])) {
          $sonuc = Crud::adminsLogin(htmlspecialchars($_POST['admins_username']), htmlspecialchars($_POST['admins_pass']), $_POST['remember_me']);
      }
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" name ="admins_login" class="btn btn-primary btn-block btn-flat">Sign In</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
